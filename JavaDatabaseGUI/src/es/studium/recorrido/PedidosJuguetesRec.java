...
public class PedidosJuguetesRec extends JFrame implements ActionListener {
	...
	public PedidosJuguetesRec() {
		...
		// Rellenamos los campos con los datos del PedidoJuguete
		try {
