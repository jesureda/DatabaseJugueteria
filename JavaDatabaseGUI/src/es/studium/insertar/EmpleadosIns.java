...
public class EmpleadosIns extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (btnSi.equals(ae.getSource())) {
			try {
				...
				statement.executeUpdate("INSERT INTO Empleados (nombre, apellidos, dni, telefono, turno) VALUES ('"
