...
public class ProveedoresIns extends JFrame implements ActionListener {
		...
		if (btnSi.equals(ae.getSource())) {
			try {
				...
				statement.executeUpdate(
						"INSERT INTO Proveedores (nEmpresa, direccion, telefono, cif) VALUES ('" + text1.getText()
