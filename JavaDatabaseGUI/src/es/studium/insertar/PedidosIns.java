...
public class PedidosIns extends JFrame implements ActionListener, ItemListener {
	...
	public PedidosIns() {
		...
		// Rellena el choice de la FK con los Clientes
		try {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (btnSi.equals(ae.getSource())) {
			try {
				statement = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
				statement.executeUpdate("INSERT INTO Pedidos (fecha, urgente, idClienteFK) VALUES ('" + text1.getText()
						+ "','" + text2.getText() + "'," + FK + ")");
				text1.setText("");
				text2.setText("");
				lista.select(0);
